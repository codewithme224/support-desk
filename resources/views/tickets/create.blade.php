    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Ticket Form') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{ route('tickets.store') }}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('issue')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="State issue reported" id="issue" name="issue">
                                        @error('issue')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('resolution')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="resolution" rows="5" placeholder="Description of method/steps used to resolve the request " name="resolution"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="about">{{ 'Method Of Procedure' }}</label>
                        <div class="@error('mop')border border-danger rounded-3 @enderror">
                            {{-- <textarea class="form-control" id="mop" rows="3" placeholder="A link to any MOP consulted or constructed" name="mop"></textarea> --}}
