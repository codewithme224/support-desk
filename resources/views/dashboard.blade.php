      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Ticket Count</p>
                <h5 class="font-weight-bolder mb-0">
                  {{$total_tickets}}
                  <span class="text-success text-sm font-weight-bolder">+{{ $percentage_of_total_tickets }}%</span>
                </h5>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0">
                  {{$open_tickets}}
                  <span class="text-success text-sm font-weight-bolder">+{{ $percentage_of_open_tickets }}%</span>
                </h5>
              </div>
            </div>
            <div class="col-4 text-end">
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0">
                  {{ $closed_tickets }}
                  <span class="text-danger text-sm font-weight-bolder">+{{ $percentage_of_closed_tickets }}%</span>
                </h5>
              </div>
            </div>
            <div class="col-4 text-end">
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0">
                  {{ $pending_tickets }}
                  <span class="text-success text-sm font-weight-bolder">+{{ $percentage_of_pending_tickets }}%</span>
                </h5>
              </div>
            </div>
            <div class="col-4 text-end">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="d-flex flex-column h-100">
                <p class="mb-1 pt-2 text-bold">Welcome to the</p>
                <h5 class="font-weight-bolder">Shift Ticketing System!</h5>
                <p class="mb-5">This system is designed to streamline the process of reporting and resolving issues during shift transitions.</p>
        ...
        <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                    ...
                    @foreach ($tickets_dash as $ticket)
        ...
        {{-- <div class="card-body px-0 pb-2">
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Requests/Issue</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Specialist</th>
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Status</th>
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Resolution</th>
                </tr>
              </thead>
              <tbody>
                <tr>
